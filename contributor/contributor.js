...
async function fetchData() {
  try {
      const contributorsResponse = await fetch('https://api.github.com/repos/tanishaness/SPROCTOR/contributors');
      const contributorsData = await contributorsResponse.json();

      const repoResponse = await fetch('https://api.github.com/repos/tanishaness/SPROCTOR');
